          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                final filteredOrders = docs.where((d) {
                  final data = d.data() as Map<String, dynamic>;
                  final status = (data["orderStatus"] ?? "Placed").toString();
                  final delivered = status == "Delivered";

                  if (showOngoing) return !delivered; // ongoing
                ...
                if (filteredOrders.isEmpty) {
                  return Center(
                    child: Text(
                      showOngoing ? "No ongoing orders" : "No completed orders",
                    ),
                  );
                }
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final image =
                        firstItem?["cartImage"] ?? firstItem?["imageUrl"];
